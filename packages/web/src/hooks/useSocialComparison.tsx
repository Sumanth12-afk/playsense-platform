    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            if (totalMinutes < ageGroupData.avg_weekly_minutes) {
                insights.push(`Your child plays ${Math.round((1 - totalMinutes / ageGroupData.avg_weekly_minutes) * 100)}% less than average for their age group`);
            } else {
                insights.push(`Your child plays ${Math.round((totalMinutes / ageGroupData.avg_weekly_minutes - 1) * 100)}% more than average for their age group`);
            }
