                ...
                <div className="space-y-6 mt-4">
                        ...
                        <div className="space-y-3 text-sm">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">They can see what's available and how many points needed</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center text-xs font-bold text-purple-600 dark:text-purple-400">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">Points are deducted and request is created</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center text-xs font-bold text-purple-600 dark:text-purple-400">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">It appears in "Pending Redemptions" on your dashboard</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center text-xs font-bold text-purple-600 dark:text-purple-400">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">Add optional notes explaining your decision</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center text-xs font-bold text-purple-600 dark:text-purple-400">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <ul className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
                            <li>• You have <strong>full control</strong> - approve or deny every request</li>
                            <li>• Points are <strong>automatically refunded</strong> if you deny</li>
                            <li>• This encourages <strong>positive behavior</strong>, not just restriction</li>
                            <li>• Children become <strong>partners</strong> in managing their gaming</li>
                        </ul>
                    </div>
                </div>
