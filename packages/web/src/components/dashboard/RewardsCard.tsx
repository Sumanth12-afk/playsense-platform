...
export function RewardsCard({ childId, childName }: RewardsCardProps) {
  ...
  const upcomingRewards =
    rewards
      ?.filter((r) => r.points_required > (pointsBalance || 0))
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="p-3 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg text-center">
              <p className="text-sm text-muted-foreground">{childName} will receive</p>
              <p className="text-2xl font-bold text-yellow-600">+{awardAmount} points</p>
            </div>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewReward((prev) => ({ ...prev, type: e.target.value as typeof prev.type }))
                }
                className="w-full mt-1 px-3 py-2 border rounded-md text-foreground bg-background"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewReward((prev) => ({
                    ...prev,
                    points: Math.max(10, parseInt(e.target.value) || 10),
                  }))
                }
