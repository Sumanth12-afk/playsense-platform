        ...
        try {
         ...
         VALUES ('child_id', ?, datetime('now'))`).run(trimmedChildId);
            ...
            try {
                ...
                const supabase = createClient(process.env.VITE_SUPABASE_URL || 'https://ycwlwaolrzriydhkgrwr.supabase.co', process.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inljd2x3YW9scnpyaXlkaGtncndyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NzY5NDc4OSwiZXhwIjoyMDgzMjcwNzg5fQ.rQlBQ1UAm-QKCOSUilyWZKi4HLO8HC5cnSdXvws8tCM');
